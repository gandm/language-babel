...
Language grammar for ES2015/ES2016 JavaScript, [Facebook React JSX](http://facebook.github.io/react/index.html) syntax and [Facebook flow](http://flowtype.org/). The colour of syntax is determined by the theme in use. The package also provides auto [indentation](#automatic-indenting-of-jsx), [completion](#auto-completion-of-jsx-tags-elements-and-attributes) , reformatting and [commenting](#commenting-out-jsx-elements) JSX tags based upon ESLint rules as well as optional Babel [transpilation on file saves](#interface-to-babel-v6-v5). As a convenience it also provides a transpiled code preview by linking to the package [source-preview](https://atom.io/packages/source-preview).
